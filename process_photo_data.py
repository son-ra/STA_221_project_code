...
#         print(len(fog_aware_stats))
    if (f % 1000 == 0):
        fog_aware_stats.to_csv('fog_aware_stats_horizontal_3_patches.csv')
...
#         print(len(fog_aware_stats))
    if (f % 1000 == 0):
        fog_aware_stats.to_csv('fog_aware_stats_horizontal_6_patches.csv')
...
for f in range(len(links_and_labels_loop)):
    ...
    patches = patchify(im, (y_patch, x_patch, 3), (min(x_patch, y_patch)))
    patches_reshape = np.reshape(patches, (patches.shape[0]*patches.shape[1]*patches.shape[2]
                                           , y_patch, x_patch, 3))
...
#         print(len(fog_aware_stats))
    if (f % 1000 == 0):
        fog_aware_stats.to_csv('fog_aware_stats_4_equal_patches.csv')
